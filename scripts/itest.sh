...
ATS_TEST_DATABASE_URL="$DB" npx vitest run tests/ats-integration.test.ts tests/e2e-funnel.test.ts tests/invoices-integration.test.ts tests/promotions-integration.test.ts "$@"
