...
export const metadata: Metadata = {
  title: { default: "Your offer", template: "%s · Sohum Systems" },
  robots: { index: false, follow: false },
};

/**
 * Minimal branded chrome for the candidate-facing offer surface — no
 * marketing nav, no admin sidebar. Sits under the root layout (fonts,
 * globals) as a sibling to (site) and admin.
 */
export default function OfferLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-dvh flex-col bg-paper-100">
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-5 py-8 sm:px-8">{children}</main>
